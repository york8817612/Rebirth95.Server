namespace Rebirth.Network
{
    public enum SendOps
    {
        ...
        LP_QuestClear = 0x30, // SHOW_QUEST_COMPLETION
        LP_EntrustedShopCheckResult = 0x31, // SEND_TITLE_BOX in odin
        ...
        LP_GroupMessage = 0x96, // MULTICHAT
        LP_Whisper = 0x97,
        ...
        LP_Premium = 0xEB,
        LP_MesoGive_Succeeded = 0xEC, // LUCKSACK_PASS = 0xF1
        LP_MesoGive_Failed = 0xED, // LUCKSACK_FAIL = 0xF2
        LP_Random_Mesobag_Succeed = 0xEE, // MESO_BAG_MESSAGE = 0xF3
        LP_Random_Mesobag_Failed = 0xEF, // LUCKSACK_EMPTY = 0xF4
        ...
        LP_UserBalloonMsg = 0xF5, // PLAYER_HINT = 0xFA
        LP_PlayEventSound = 0xF6,
        LP_PlayMinigameSound = 0xF7,
        LP_UserMakerResult = 0xF8, // MAKER_RESULT
        LP_UserOpenConsultBoard = 0xF9,
        LP_UserOpenClassCompetitionPage = 0xFA,
        LP_UserOpenUI = 0xFB,
        LP_UserOpenUIWithOption = 0xFC,
        LP_SetDirectionMode = 0xFD, // LOCK_UI
        LP_SetStandAloneMode = 0xFE, // DISABLE_UI
        LP_UserHireTutor = 0xFF, // SPAWN_GUIDE
        LP_UserTutorMsg = 0x100, // TALK_GUIDE
        LP_IncCombo = 0x101, // SHOW_COMBO
        ...
        LP_MapleTVUpdateMessage = 0x195, // CMapleTVMan::OnSetMessage
        LP_MapleTVClearMessage = 0x196, // CMapleTVMan::OnClearMessage
        LP_MapleTVSendMessageResult = 0x197, // CMapleTVMan::OnSendMessageResult
        ...
        ////CUSTOM PACKETS BELOW ONLY
        //LP_CustomConfig = 0x500,
        //LP_CustomEmoji = 0x501,
        ////PLACEHOLDER
        //LP_CustomTeleport = 0x504,
        //LP_CustomSecurity = 0x505,
        ////PLACEHOLDER
        //LP_CustomGainNX = 0x507,
        ////PLACEHOLDER
        //LP_CustomUserEnter = 0x509,
        //LP_CustomUserLeave = 0x510,
        
        //// CUstom Field Packets
        //LP_CustomFieldDeathCount = 0x600
};
    public enum RecvOps
    {
        #region 未使用
        ...
        CP_SetPassengerResult = 0x8A,
        CP_BroadcastMsg = 0x8B,
        CP_GroupMessage = 0x8C,
        CP_Whisper = 0x8D,
        CP_CoupleMessage = 0x8E,
        CP_Messenger = 0x8F,
        CP_MiniRoom = 0x90,     // PLAYER_INTERACTION in odin
        ...
        ////CUSTOM PACKETS BELOW ONLY
        //CP_CustomConfig = 0x500,
        //CP_CustomSecurityInit = 0x501,
        //CP_CustomSecurityAlive = 0x502,
        //CP_ApplyHotFix = 0x503,
        //CP_CustomFreeMarket = 0x504,
        //CP_CustomGlobalShop = 0x505,
    };
}
